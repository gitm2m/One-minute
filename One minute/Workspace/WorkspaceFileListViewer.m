...
NSInteger sort_id(id a, id b, void *reverse) {
...
- (void)viewDidLoad
{
    ...
    filesList = [[NSMutableArray alloc] initWithArray:[[manager contentsOfDirectoryAtPath:documents error:nil] sortedArrayUsingFunction:sort_id context:&reverseSort]];
